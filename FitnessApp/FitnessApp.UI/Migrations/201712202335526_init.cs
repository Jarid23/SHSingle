                ...
                c => new
                    {
                        ...
                        TrainerCreator_TrainerID = c.Int(),
                    })
                .PrimaryKey(t => t.WorkoutID)
                .ForeignKey("dbo.Trainers", t => t.TrainerCreator_TrainerID)
                .Index(t => t.TrainerCreator_TrainerID);
            
        }
        
        public override void Down()
        {
            DropForeignKey("dbo.Workouts", "TrainerCreator_TrainerID", "dbo.Trainers");
